...
function Author (){
    ...
    const handleSubmit = (e) => {
        let url_set;
        e.preventDefault();
        url_set = `https://www.googleapis.com/books/v1/volumes?q=inauthor:${authorName}&maxResults=15&startIndex=${page}`;
    ...
    const handleNextPage = () =>{
        let next_url_set = `https://www.googleapis.com/books/v1/volumes?q=inauthor:${authorName}&maxResults=15&startIndex=${page+15}`;
    ...
    const handlePreviousPage = () =>{
        let previous_url_set = `https://www.googleapis.com/books/v1/volumes?q=inauthor:${authorName}&maxResults=15&startIndex=${page-15}`;
        ...
        <div>
            <section id="form_result_part">
                <form onSubmit={handleSubmit} id="form_wrapper">
                    ...
                    <input type="submit" value="Authors Search" />
                </form>

                <div id="search_result_number_wrapper">
                    {(total_number)?
                        <ul class="search_result">
                            <li><p id="search_keyword">Search Keyword : <span>{authorName}</span></p></li>
                    ...
                    {(total_number==0)?
                        <div class="search_result_number">
                            <p class="zero_result">Search Keyword : <span> {authorName} </span></p>
